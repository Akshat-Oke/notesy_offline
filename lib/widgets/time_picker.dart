...
class TimePicker extends StatefulWidget {
  TimePicker(this.note);
  final Note? note;
  @override
  _TimePickerState createState() => _TimePickerState(note);
}

class _TimePickerState extends State<TimePicker> {
  _TimePickerState(this.note);
  Note? note;
                        ...
                        if (this.selectedDate != DateTime.now() ||
                          ...
                          try {
                            await NotificationHelper.handleReminderNotification(
                                ...
                                note: this.note);
                            await this.note?.addReminder(context.read<NoteService>().strCurrentBox);
                          } catch (e) {
                            print(e.toString());
                          } finally {
                            print("Done");
