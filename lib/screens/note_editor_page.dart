...
import 'package:notesy_offline/services/text_editor_service.dart';
import 'package:notesy_offline/widgets/note_card.dart';
import 'package:provider/provider.dart';
import 'package:notesy_offline/services/add_note.dart';
import 'package:notesy_offline/widgets/time_picker.dart';
...
class _NoteEditorState extends State<NoteEditor> {
  ...
  _NoteEditorState(Note? note) {
    ...
    this.showDelete = note != null && note.fromDefaultLabel != true;
    this._note = note ?? Note();
    this._originalNote = note?.copy() ?? Note();
    this.noteColor = _note?.color == null
        ? Color(0xFF1f1d2a)
    ...
    this._titleTextController =
        TextFieldColorizer(colorControlMap, text: note?.title);
    this._contentTextController =
        TextFieldColorizer(colorControlMap, text: note?.content);
        ...
        builder: (_, __, ___) => Hero(
          ...
          child: Theme(
            ...
            child: AnnotatedRegion<SystemUiOverlayStyle>(
              ...
              child: WillPopScope(
                onWillPop: () =>
                    _onPop(box: context.read<NoteService>().strCurrentBox),
                child: Scaffold(
                  key: _scaffoldKey,
                  appBar: AppBar(
                    ...
                    leading: IconButton(
                      ...
                      icon:
                          _isDirty ? Icon(Icons.check) : Icon(Icons.arrow_back),
  ...
  Future<bool> _onPop({required String box}) {
    print(
    ...
    if (_isDirty && (_note?.id != null || _note!.isNotEmpty)) {
      ...
      _note!
        ...
        ..saveToFireStore(boxName: box);
    }
    return Future.value(true);
  }

  Future<bool> _deleteNote(String box) async {
    await _note!.deleteFromFireStore(box);
    return Future.value(true);
  }

  List<Widget> _noteActions(BuildContext context) {
    return [
      TimePicker(this._note),
      IconButton(
                ...
                content: SingleChildScrollView(
                  child: BlockPicker(
                    ...
                    onColorChanged: (color) {
                      ...
                      this
                          ._note
                          ?.updateWith(color: color.value.toRadixString(16));
                    },
                  ),
                ),
              );
      ...
      if (showDelete)
        IconButton(
            ...
            onPressed: () {
              _deleteNote(context.read<NoteService>().strCurrentBox)
  ...
  Widget _buildNoteDetail() => Column(
        ...
        children: <Widget>[
          TextField(
            ...
            style: TextStyle(
                color: Colors.white, fontSize: 22.0), //kNoteTitleLight,
              ...
              children: [
                InkWell(
                  onTap: () async {
                    ...
                    // if (uid != null)
                    await this._note?.deleteReminder(
                        context.read<NoteService>().strCurrentBox);
                  },
                  child: Container(
                    padding:
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            ...
                            fontSize: 13.2,
                            decoration: !_note!.reminderExists
          ...
          TextField(
            ...
            decoration:
                const InputDecoration.collapsed(hintText: 'Take your note...'),
            maxLines: null,
          ...
          Wrap(
            ...
            children: [...?_note?.labelsHereFunction(context)],
          )
        ],
      );
  ...
  void _undoAllChanges() {
    print(
        "modified: ${_note?.strLastModified} created: ${_note?.strCreatedAt}");
  ...
  void _onCloudNoteUpdated(Note? note) {
    print(
        "Updated on cloud ${!mounted} || ${note?.isNotEmpty != true} || ${_note == note}");
