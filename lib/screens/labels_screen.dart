              ...
              children: [
                ...
                ListTile(
                  ...
                  title: Text(
                    "Add a new Label",
                    style: TextStyle(
                        color: const Color(0xFFFEFEFE), fontSize: 20.0),
                  ),
                ),
                ListView.builder(
                  shrinkWrap: true,
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final label = boxContents.getAt(index);
                    print(index.toString());
                    return Dismissible(
                      background: Container(color: Colors.red),
                      key: Key(label!.key.toString()),
                      resizeDuration: Duration(milliseconds: 200),
                      onDismissed: (direction) {
                        setState(() {
                          label.deleteLabelFromFireStore();
                        });
                      },
                      child: ListTile(
                        onTap: () {},
  ...
  void _addNewLabelDialog(BuildContext context) async {
    await showDialog(
      ...
      builder: (context) {
        return AlertDialog(
            titleTextStyle:
                const TextStyle(color: const Color(0xFFFEFEFE), fontSize: 20.0),
